            ...
            <form class="form" id="fo" method="post">
                ...
                <div class="mail_wrap">
                    ...
                    <div class="mail_check_wrap">
                        <div class="mail_check_input_box" id="mail_check_input_box_false">
                            <input style="margin-left: 160px;" class="mail_check_input" id="mail1" type="text"
                                   disabled="disabled">
                            <input type="button" class="mail_check_button btn btn-outline-secondary"
                        ...
                        <br>
                        <input type="button" style="width: 100px; height: 30px; margin-left: 10px;"
                               class="btn btn-outline-secondary" value="확인">
                ...
                <div>
                    ...
                    <input style="margin-left: 165px;" type="text" id="addr2" name="memberAddress2"
                           placeholder="주 소"><br>
                    <input style="margin-top: 10px; margin-left: 165px;" class="address_input" type="text" id="addr3"
                           placeholder="상 세 주 소"><br>
                    <span class="final_addr_ck">주소를 입력하세요</span>
                </div>
                <br>
                <button type="button" style="width: 125px; height: 50px;" class="btn btn-outline-danger"
                        onclick="location.href='${contextPath }/com.bit.member/login' ">취소
                </button>
                <input type="button" style="width: 125px; height: 50px;" class="btn btn-outline-info join_button"
                       onclick="register()" value="회원가입"><br><br>
