    ...
    <div class="aside">
                ...
                <li>
                    <div class="menu-nav">
                        <a class="nav-link" href="#">
                            <div class="p">
                                <div class="p-2"><b>My com.bit.board</b></div>
        ...
        <div class="section">
            ...
            <form class="form" action="modify" method="post" onsubmit="foo();">
                <label><b>ID</b></label> &nbsp; &nbsp;
                <input style="background-color: #00264d; color: white;" type="text" name="id"
                       value="${memberList.memberId }" readonly><br>
                ...
                <input style="background-color: #00264d; color: white;" type="text" name="name"
                       value="${memberList.memberName }" readonly><br>
                ...
                <input class="post" type="text" id="addr1" value="${memberList.memberAddress }" name="memberAddress"
                       placeholder="우편번호">
                <input type="button" class="btn btn-outline-secondary"
                       style="font-size: 9px; text-align: center; width: 100px; margin-bottom: 3px;"
                       onclick="daumPost()" value="우편번호 검색"><br>
                <input style="margin-left: 165px;" type="text" id="addr2" name="memberAddress2"
                       value="${memberList.memberAddress2 }" placeholder="주 소"><br>
                <input style="margin-top: 10px; margin-left: 165px;" type="text" id="addr3" placeholder="상 세 주 소"><br>

                <label><b>Join Date</b></label> &nbsp; &nbsp;
                <input style="background-color: #00264d; color: white;" type="text" name="name"
                       value="${memberList.memberCreateDate }" readonly><br>
                <br>

                <br>
                <div class="form-button">
                    <input type="submit" id="modify" style="width: 125px; height: 50px;" class="btn btn-outline-info"
                           value="회원정보 수정"> &nbsp; &nbsp;
                    <input type="button" style="width: 125px; height: 50px;" class="btn btn-outline-danger"
                           onclick="history.back()" value="취소"> &nbsp; &nbsp;
                    <input type="button" id="delete" style="width: 125px; height: 50px;"
                           class="btn btn-outline-secondary"
                           onclick="location.href='${contextPath }/com.bit.member/delete?memberId=${delete.userId }' "
                           value="회원 탈퇴">
                    <br><br><br>
                </div>
            </form>
