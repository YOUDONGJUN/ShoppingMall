...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            price =
            ${cart.cartProductPrice } * ${cart.cartProductCounts }
        ...
        <form id="fo" action="${contextPath}/myPage/cart" method="get">
            <table class="table">
                ...
                <c:forEach var="cart" items="${cart}">
                    <tr>
                        <td class="checkBoxTd">
                            <input type="checkbox" name="chtest" class="checkBox" value="${cart.cartProductId }"
                                   onclick="resetPrice()" id="${cart.cartId }${cart.cartId }${cart.cartId }">
                        </td>
                        <td class="itemImageTd">
                            <img class="logo"
                                 src="${pageContext.request.contextPath}/resources/img/${cart.cartProductFile1}.jpg"
                                 width="100px;">
                        </td>
                        <td class="itemInfoTd">
                                ${cart.cartProductId }
                        ...
                        <td class="orderCountTd">
                            ...
                            <input type="button" class="btn btn-light orderCountModifyBtn" value="수정"
                                   onclick="update()">
