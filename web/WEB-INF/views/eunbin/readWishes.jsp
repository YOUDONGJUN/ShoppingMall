                            ...
                            <div class="d-flex p-3 alignItemsFlexStart">
                                <div class="width50 p-2  minHeight234px maxHeight234px">
                                    <div style="height:100%;">
                                        <img style="max-width: 320px" class="card-img-top minWidth300px maxHeight234px"
                                             src="<tags:url value='/resources/img/${wishDto.wishName}.jpg'/>"
                                             alt="Card image">
                                    </div>
                                </div>
                                <div style="width:50%; height:250px; text-align: left;" class="p-2">
                                    <div class="d-flex flex-column">
                                        <div class="p-2"><b>상품명 : </b>${wishDto.wishName } </div>
                                        <br>
                                        <div class="p-2"><b>수량 : </b>${wishDto.wishCounts } </div>
                                        <br>
                                        <div class="p-2"><b>가격 : </b>${wishDto.wishTotalPrice }</div>
                                        <br>
                                    </div>
                                    <br>
