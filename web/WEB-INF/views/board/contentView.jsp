            ...
            <td colspan="4" align="center">
                ...
                <c:if test="${loginUser ==  personalData.id}">
                    <input type="button" class="btn btn-outline-info"
                           onclick="location.href='${contextPath }/com.bit.board/modify_form?writeNo=${personalData.writeNo }'"
                           value="수정하기">
                    <input type="button" class="btn btn-outline-danger" onclick=
                            "location.href='${contextPath }/com.bit.board/delete?writeNo=${personalData.writeNo }&imageFileName=${personalData.imageFileName }'"
                           value="삭제하기">
                </c:if>
                ...
                <input type="button" class="btn btn-outline-success"
                       onclick="location.href='${contextPath }/com.bit.board/boardAllList'" value="리스트로 돌아가기">
            </td>
        </tr>
    </table>
</div>
    ...
    <div id="first">
        <div style="width:250px; margin: 0 auto; padding-top: 20px;">
            <form id="frm">
                ...
                <b>작성자 : ${loginUser }</b>
                <hr>
                <b>제목</b> <br> <input type="text" id="title" size="25" name="title">
                <hr>
