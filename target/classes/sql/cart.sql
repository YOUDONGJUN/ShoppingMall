...
COMMENT ON TABLE com.bit.cart IS '장바구니'
/

COMMENT ON COLUMN com.bit.cart.cart_id IS '장바구니 아이디'
/

COMMENT ON COLUMN com.bit.cart.member_id IS '회원 아이디'
/

COMMENT ON COLUMN com.bit.cart.cart_product_id IS '장바구니 상품 아이디'
/

COMMENT ON COLUMN com.bit.cart.cart_product_price IS '장바구니 상품 가격'
/

COMMENT ON COLUMN com.bit.cart.cart_product_file_1 IS '장바구니 상품 파일'
/

COMMENT ON COLUMN com.bit.cart.cart_product_counts IS '장바구니 상품 개수'
/
