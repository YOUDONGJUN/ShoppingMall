...
(
    ...
    delivery_requirement    VARCHAR2(255)    NULL,
    delivery_address        VARCHAR2(255)    NOT NULL,
    seller_phone            NUMBER           NULL, 
    delivery_status         VARCHAR2(45)     NOT NULL,
...
insert into order_details (order_id, delivery_address, delivery_status, buyer_idx)
