                ...
                <td colspan="4" align="center">
                    ...
                    <c:if test="${loginUser ==  personalData.noticeWriterId}">
                        <input type="button" class="btn btn-outline-info" style="width: 20%;"
                               onclick="location.href='${contextPath }/com.bit.notice/modify_form?noticeId=${personalData.noticeId }'"
                               value="수정">
                        <input type="button" class="btn btn-outline-danger" style="width: 20%;"
                               onclick="location.href='${contextPath }/com.bit.notice/delete?noticeId=${personalData.noticeId }&noticeImageFileName=${personalData.noticeImageFileName}'"
                               value="삭제">
                    </c:if>
                    <c:if test="${loginUser != null}">
                        <input type="button" class="btn btn-outline-secondary" style="width: 20%;"
                               onclick="slideClick()" value="답글달기">
                    </c:if>
                    <input type="button" class="btn btn-outline-success" style="width: 20%;"
                           onclick="location.href='${contextPath }/com.bit.notice/noticeAllList'" value="목록"></td>
            </tr>
        </table>
    </div>
    <div id="modal_wrap">
        <div id="first">
            <div style="width: 400px; text-align:center; margin: 0 auto; padding-top: 20px;">
                <form id="frm">
                    ...
                    <h5><b> 답 글 작 성</b></h5>
                    <hr>
                    <b>I D &nbsp;&nbsp;&nbsp;</b>&nbsp; &nbsp;<input style="border:0.1px;  text-align: center;"
                                                                     type="text" name="id" value=" ${loginUser }"
                                                                     readonly>
                    <hr>
                    <b>TITLE</b>&nbsp; &nbsp;<input style="border:0.1px;" type="text" id="title" name="notice_title">
                    <hr>
                    <b>CONTENT</b><br> <textarea style="border:0.1px;" rows="3" cols="50" id="content"
