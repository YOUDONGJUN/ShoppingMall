...
<div class="content">
    <div style="height:90%;" class="d-flex flex-column"><br><br>
        <h3 style=" text-align: center;"><b>상품후기 작성</b></h3>    <br>
        <hr style="color: #005cb3;">
        ...
        <form action="${contextPath }/member/saveReview" method="post" enctype="multipart/form-data">
            <div style="height:90%; /* overflow-y:scroll; */ " class="d-flex flex-column">
                <div class="d-flex p-3">
                    ...
                    <input type="text" name="title" style="width:500px; padding-left:10px;" placeholder="제목을 입력해주세요"
                           class="form-control">
                </div>
                ...
                <div class="p-2">
                    <div class="d-flex p-3  text-white alignItemsFlexStart">
                        <div style="position:relative; color:black; width:50%;" class="p-2 ">
                            <div style="height:100%;">
                                <img class="card-img-top minWidth300px maxHeight234px"
                                     src="<tags:url value='/resources/img/${orderProductName}.jpg'/>" alt="Card image">
                            </div>
                        </div>
                        <div style="margin-top:10px; position:relative; color:black; width: 50%;"
                             class="p-2  marginLeft40px">
                            <div class="d-flex flex-column">
                                <div class="p-2"><b>상품명 : </b>&nbsp; ${orderProductName}</div>
                                <div class="marginTop100px p-2">
                                    <b>상품평</b>
                                    <select name="score" style="float:right; width:100px; margin-right: 10px; "
                        ...
                        <div style="display:flex; flex-direction:column; margin-top:10px; height:220px; position:relative; color:black;  justify-content: space-between; width: 50%;"
                             class="p-2  marginLeft40px">
                            <div class="form-check margin10px">
                                <input class="form-check-input" type="radio" name="degree" value="좋아요"
                            ...
                            <div class="form-check margin10px">
                                <input class="form-check-input" type="radio" name="degree" value="보통이예요"
                            ...
                            <div class="form-check margin10px">
                                <input class="form-check-input" type="radio" name="degree" value="나빠요"
                ...
                <div class="p-2 ">
                    <div class="custom-file" style="width: 95%; margin-left: 25px;">
                        <input style="width: 500px; margin-right: 80px;" type="file" name="image_file_name"
                ...
                <div class="p-2 ">
                    ...
                    <div class="d-flex p-3  text-white alignCenter justifyContentCenter">
                        <button type="submit" class="btn btn-outline-info margin20px" style="width: 300px;"
                                value="상품평쓰기">등록
                        </button>
                        <button type="button" class="btn btn-outline-secondary  margin20px" style="width: 300px;"
                                onclick="location.href='${pageContext.request.contextPath}/com.bit.member/readOrders'">
                            취소
                        </button>
                    </div>
                </div>
